    ...
    return (
        <div className="space-y-6 max-w-5xl">
            ...
            <div
                ...
                className="border-2 border-dashed border-slate-300 dark:border-slate-700/60 rounded-2xl p-10 text-center cursor-pointer hover:border-indigo-500/40 transition"
            >
