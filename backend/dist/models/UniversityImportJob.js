...
const UniversityImportRowErrorSchema = new mongoose_1.Schema({
    rowNumber: { type: Number, required: true },
    reason: { type: String, required: true },
    payload: { type: mongoose_1.Schema.Types.Mixed, default: undefined },
}, { _id: false });
const UniversityImportJobSchema = new mongoose_1.Schema({
    ...
    mapping: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    defaults: { type: mongoose_1.Schema.Types.Mixed, default: {} },
    validationSummary: {
...
exports.default = mongoose_1.default.model('UniversityImportJob', UniversityImportJobSchema);
//# sourceMappingURL=UniversityImportJob.js.map